      ...
      {results.map((train, idx) => (
        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-foreground group-hover:text-rail-blue">
                    {train.name}
                  </h4>
                </div>
            ...
            {train.duration && (
              <div className="hidden sm:flex items-center gap-1.5 rounded-xl bg-secondary px-3 py-1.5 text-xs font-semibold text-muted-foreground">
