  ...
  return (
    <div className="space-y-8 pt-20">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-foreground">My Favorites</h1>
            ...
            {favorites.map((train, idx) => (
              ...
              >
                <Link
                  ...
                  className="glass-card group relative flex items-center justify-between rounded-2xl p-4 transition-all duration-200 hover:-translate-y-0.5 animated-border"
                >
