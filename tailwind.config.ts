  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glow: '0 0 20px -5px rgba(8, 127, 229, 0.4)',
        'glow-strong': '0 0 30px -5px rgba(8, 127, 229, 0.5), 0 0 60px -10px rgba(8, 127, 229, 0.2)',
      ...
      backgroundImage: {
        ...
        'gradient-premium': 'linear-gradient(135deg, rgba(8, 127, 229, 0.1) 0%, rgba(6, 182, 212, 0.05) 50%, transparent 100%)',
      },
    },
  },
  plugins: [],
